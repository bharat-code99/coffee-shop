      ...
      <div className='pb-8 px-8 sm:pb-0'>
        <div className='grid grid-cols-1 sm:grid-cols-2'>
          ...
          <div className='flex flex-col items-start justify-center gap-6 order-2 sm:order-1'>
            <h1 className='text-5xl sm:text-6xl font-bold'>We serve the richest <span className='text-primary font-pacifico'>Coffee</span> in the city</h1>
          ...
          {/* Image Section */}
          <div className='flex justify-end items-center order-1 sm:order-2 relative'>
            <img src={HeroImg} alt="Coffee Image" className='w-[300px] sm:w-[500px] spin'/>
            <div className='bg-gradient-to-r from-primary to-secondary absolute top-10 left-14 p-3 rounded-xl'>Hey Coder</div>
            <div className='bg-gradient-to-r from-primary to-secondary absolute bottom-9 right-9 p-3 rounded-xl'>Best Coffee</div>
          </div>
        </div>
      </div>
    </div>
