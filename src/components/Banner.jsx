      ...
      <div className='px-20 min-h-[500px] flex justify-center items-center py-10 sm:py-0'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col justify-center gap-6'>
            <h1 data-aos="fade-up" className='text-3xl sm:text-4xl font-pacifico font-bold text-gray-800'>Premium Blend Coffee</h1>
            <p data-aos="fade-up" className='text-gray-600 tracking-wide leading-5'>Coffee is a beloved beverage made from roasted beans, offering rich flavors, caffeine boost, and cultural significance worldwide in various brewing styles.</p>
            <div className='grid grid-cols-2'>
              ...
              <div data-aos="slide-left" className='border-l-4 border-primary pl-6 space-y-3'>
